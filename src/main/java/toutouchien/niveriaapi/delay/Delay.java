...
public class Delay {
	...
	Delay(@NotNull Player player, Consumer<Player> successConsumer, Consumer<Player> failConsumer, int delay, boolean cancelOnMove, boolean actionbar, boolean chat, boolean title) {
		this.player = player;
