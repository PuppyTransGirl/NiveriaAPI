	...
	private DyeColor dyeColor(Material material) {
		return switch (material) {
			...
			case PINK_BANNER, PINK_BED, PINK_BUNDLE, PINK_CANDLE, PINK_CANDLE_CAKE, PINK_CARPET, PINK_CONCRETE,
                 ...
                 PINK_STAINED_GLASS, PINK_STAINED_GLASS_PANE, PINK_WALL_BANNER, PINK_HARNESS, PINK_TULIP, PEONY, PINK_PETALS ->
					DyeColor.PINK;
			...
			case LIGHT_GRAY_BANNER, LIGHT_GRAY_BED, LIGHT_GRAY_BUNDLE, LIGHT_GRAY_CANDLE, LIGHT_GRAY_CANDLE_CAKE,
				 ...
				 LIGHT_GRAY_STAINED_GLASS_PANE, LIGHT_GRAY_WALL_BANNER, LIGHT_GRAY_HARNESS, AZURE_BLUET, OXEYE_DAISY, WHITE_TULIP ->
					DyeColor.LIGHT_GRAY;
			...
			case BROWN_BANNER, BROWN_BED, BROWN_BUNDLE, BROWN_CANDLE, BROWN_CANDLE_CAKE, BROWN_CARPET, BROWN_CONCRETE,
				 ...
				 BROWN_SHULKER_BOX, BROWN_STAINED_GLASS, BROWN_STAINED_GLASS_PANE, BROWN_WALL_BANNER, BROWN_HARNESS, COCOA_BEANS ->
					DyeColor.BROWN;
			...
			case GREEN_BANNER, GREEN_BED, GREEN_BUNDLE, GREEN_CANDLE, GREEN_CANDLE_CAKE, GREEN_CARPET, GREEN_CONCRETE,
				 ...
				 GREEN_SHULKER_BOX, GREEN_STAINED_GLASS, GREEN_STAINED_GLASS_PANE, GREEN_WALL_BANNER, GREEN_HARNESS, CACTUS ->
					DyeColor.GREEN;
			...
			case RED_BANNER, RED_BED, RED_BUNDLE, RED_CANDLE, RED_CANDLE_CAKE, RED_CARPET, RED_CONCRETE,
				 ...
				 RED_STAINED_GLASS, RED_STAINED_GLASS_PANE, RED_WALL_BANNER, RED_HARNESS, POPPY, RED_TULIP, ROSE_BUSH, BEETROOT ->
					DyeColor.RED;
			...
			case BLACK_BANNER, BLACK_BED, BLACK_BUNDLE, BLACK_CANDLE, BLACK_CANDLE_CAKE, BLACK_CARPET, BLACK_CONCRETE,
				 ...
				 BLACK_SHULKER_BOX, BLACK_STAINED_GLASS, BLACK_STAINED_GLASS_PANE, BLACK_WALL_BANNER, BLACK_HARNESS, INK_SAC,
				 WITHER_ROSE ->
                    DyeColor.BLACK;
